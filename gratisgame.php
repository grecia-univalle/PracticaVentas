...
$url = "https://api.rawg.io/api/games?key=$apiKey&page_size=20&ordering=-rating";
...
<main class="flex-1 p-6 overflow-hidden">
    ...
    <div class="flex flex-col lg:flex-row justify-between items-center gap-5 mb-8">
        ...
        <form method="GET" class="relative flex-1 w-full">
            ...
            <input
                ...
                placeholder="Buscar juegos gratis..."
    ...
    <div class="mb-10">
        ...
        <p class="text-gray-400 mt-3">
            Obtén videojuegos gratuitos y agrégalos a tu carrito.
        </p>
                    ...
                    <div class="card bg-[#0b1020] rounded-[30px] overflow-hidden border border-purple-900/20 hover:border-purple-500">
                        ...
                        <div class="p-5">
                            ...
                            <div class="flex justify-between items-start gap-3">
                                ...
                                <div class="bg-green-600/20 text-green-400 px-3 py-1 rounded-xl text-sm whitespace-nowrap">
                            ...
                            <div class="mt-4">
                                ...
                                <p class="text-gray-400 text-sm">
                                    ...
                                    Juego gratuito disponible para descargar y disfrutar completamente gratis.
                            ...
                            <div class="flex gap-3 mt-6">
                                ...
                                <button
                                    onclick="getGame(<?php echo $game['id']; ?>)"
                                    class="flex-1 text-center py-3 rounded-2xl bg-gradient-to-r from-green-500 to-emerald-600 font-semibold hover:scale-105 transition-all"
                                >
                                    Obtener Juego
                                </button>
